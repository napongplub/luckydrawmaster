...
-->
		...
		<link type="text/css"  href="assets/css/style_random1.css" rel="stylesheet">
...
-->
	...
	<div id="Wrapper">
		...
		<footer id="Footer" class="clearfix is-sticky">
			<div class="row" style="padding-top: 55px;">
				<div class="col-md-6">                      
				<a href="lucky_small_1.php" class="trans-btn text-white footer-btn">
					<img src="assets/img/switch-btn-Reset.png"></img>
				</a>
				<div style="color : #FFF; margin-left: 100px; ">
							<div style="float : left;">luckydrawช่วงที่2&nbsp; Glod Master จี้ทองคำ 99.99 % </div>
	...
	<script type="text/javascript" src="assets/dist/luckydraw_master_1.js"></script>
</body>
</html>
