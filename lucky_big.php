    ...
    <div id="Wrapper">
        <div class="container-fluid">
            <div class="header-space text-center">
				<img src="assets/img/logo-varp.png" alt="" class="logo" style="width: 30%;">
				<br><br>
                <section class="demos">
                    <div class="row">
				...
				<a id="clear" class=" trans-btn text-white footer-btn">
					<img src="assets/img/switch-btn-Reset.png"></img>
						...
						<div style="color : #FFF; margin-left: 100px; ">
							<div style="float : left;">luckydrawช่วงที่1 &nbsp;</div>
							<div id="prize_name" style="float : left;">พระบรมฉายาลักษณ์ ร.๙ พร้อมกรอบหลุยส์  &nbsp;</div> 
							<div id="running" style="float : left;"> 0 &nbsp;</div>
							<div style="float : left;"> / &nbsp;</div>
							<div id="all" style="float : left;"> 12 &nbsp;</div>
						</div>	    				
				</div>
