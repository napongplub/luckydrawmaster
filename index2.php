        ...
        <div id="Wrapper">
            <div class="container-fluid">
                <div class="header-space text-center">
                    <img src="assets/img/logo-varp.png" alt="" class="logo" style="width: 30% !important; padding: 0; margin: 0;">
                </div>
                <div class="content-space text-center" style="margin-top:100px; color: #FFF;" >
				<h3>Lucky draw ช่วงที่ 1</h3>
                </div>            
                <div class="footer-space text-center" style="position: absolute; bottom: 100px; width: 95%;">
                    <div class="col-md-6">
                        <button type="button" class="btn btn-lg btn-app" id="btn_lg"  >
							<span class="glyphicon glyphicon-gift" id="bg"></span>
						</button>
					<h3>Random จากหมายเลขสิทธิ์</h3>
